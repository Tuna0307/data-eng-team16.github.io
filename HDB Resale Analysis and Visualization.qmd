...
```{r}
# --- Enhanced Chart 1 (Final Version): Warning-Free and Correct ---
...
#    KEY CHANGE: Move `height = 550` into the main plot_ly() call.
fig <- plot_ly(
    data = plot_data,
    x = ~year,
    y = ~median_price,
...
#    KEY CHANGE: Remove `height` from the layout section.
fig <- fig %>% layout(
